...
public class StdRestController {
	...
	public ResponseEntity<?> getAllStudent(){
		...
		try {
			...
			resp=new ResponseEntity<String>("Unnable To Fetch Data",HttpStatus.INTERNAL_SERVER_ERROR);
			e.printStackTrace();
		}
		return resp;
	}
	...
	public ResponseEntity<String> deleteStudent(
		...
		try {
			...
			resp=new ResponseEntity<String>("Unnable To Delete",HttpStatus.INTERNAL_SERVER_ERROR);
			...
			@RequestBody Student student)
	{
		...
		try {
			...
			if(exist) {
				...
				resp=new
						ResponseEntity<String>(student.getStdId()+"-Not Exist",HttpStatus.BAD_REQUEST);
			}
		} catch (Exception e) {
